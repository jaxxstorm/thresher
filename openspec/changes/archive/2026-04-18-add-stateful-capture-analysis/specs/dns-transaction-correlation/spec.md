...
The system SHALL correlate DNS requests and responses across frames and emit a stable transaction identifier for packets that belong to the same DNS exchange.
